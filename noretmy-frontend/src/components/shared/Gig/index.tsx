      ...
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-orange-200 transform hover:-translate-y-1">
        ...
        <div className="p-4">
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
            ...
            <div className="bg-gray-900 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-all opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0">
              View
            </div>
          </div>
        </div>
